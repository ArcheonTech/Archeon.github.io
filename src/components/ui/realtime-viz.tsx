        ...
        >
          <defs>
            <linearGradient id="grad-out" x1="0" y1="0" x2="1" y2="0">
              <stop offset="0%" stopColor="#560591" />
              <stop offset="100%" stopColor="#6B69A8" />
            </linearGradient>
          ...
          <g transform="translate(160,225)">
            <circle r="44" fill="#560591" opacity="0.12" filter="url(#softGlow)" />
            <circle r="34" fill="#560591" />
            <circle r="34" className="animate-ping" fill="rgba(86,5,145,0.35)" />
